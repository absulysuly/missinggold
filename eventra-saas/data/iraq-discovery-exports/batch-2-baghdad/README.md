# Baghdad Complete Dataset - Batch 2

**Batch #2** | **Governorate:** baghdad  
**Generated:** 2025-10-03, 1:50:03 a.m.  
**Total Records:** 35
...
- **Cafe & Restaurants**: 3 records
- **Events**: 3 records
- **Tourism**: 4 records
- **Government Offices**: 5 records
- **Services**: 3 records
- **Companies**: 5 records
- **Shopping**: 7 records
...
- ✅ **Complete Records**: 35 (100%)
- ⚠️  **Partial Records**: 0
- 📍 **Geocoded**: 35 (100%)
- 🖼️  **With Images**: 35 (100%)
- ✓ **Verified**: 35
